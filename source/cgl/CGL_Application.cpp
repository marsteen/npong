...
#include <cgl/CGL_GLU_Sphere.h>
#include <cgl/CGL_Object.h>
#include <cgl/CGL_Disk.h>
#include "cgl/CGL_Ellipsoid.h"
#include <file/CFileIO.h>
#include <tools/math.h>
#include <vector/CVector3T.h>
#include <resource/CG3DGlobals.h>
#include <resource/CG3DReslistInterface.h>
#include <resource/CGL_Application.h>
...
// ---------------------------------------------------------------------------
//
// KLASSE        : CGL_Application
// METHODE       : CGL_Application
//
//
//
// ---------------------------------------------------------------------------

CGL_Application::CGL_Application()
{
    gErde = NULL;
    mActInfobox = "";
    mInitFlag = false;
...
void CGL_Application::InitPlanet(const SPlanetDesc* PlanetDesc)
{
    CGL_Texture tx;
...
void CGL_Application::SetResolution(int w, int h)
{
...
void CGL_Application::InitApplication(int argc, char* argv[])
{
    gOpenGL = new COpenGL;
...
void CGL_Application::InitResources()
{
    float Scale = 0.7;
...
void CGL_Application::Draw3DObjects()
{
    if (!mInitFlag)
    {
        return;
...
void CGL_Application::MouseMotion(int dx, int dy)
{
    if (mScale >= 1.0)
    {
...
void CGL_Application::ActivatePlanet(EPlanet p)
{
...
void CGL_Application::MouseWheel(int d)
{
    if (d == 0)
    {
        mScale += 0.05;
...
void CGL_Application::LeftMouseButtonDown()
{
    SG3DcomData scom;
...
void CGL_Application::KeyboardAction(unsigned char key)
{
...
void CGL_Application::ManageInterface(CGL_Mouse* Mouse)
{
    if (mInitFlag)
    {
