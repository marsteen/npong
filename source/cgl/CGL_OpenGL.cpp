...
void CGL_OpenGL::SetViewport(int w, int h)
{
    mWidth = w;
    mHeight = h;
...
void CGL_OpenGL::StartModelView()
{
    mAspect = (float)mWidth / (mHeight);
    glViewport(0, 0, mWidth, mHeight);
...
void CGL_OpenGL::StartProjectionView()
{
    int ow = 0;
    int oh = 0;
    glViewport(ow, oh, mWidth, mHeight);
    glMatrixMode(GL_PROJECTION);
    glLoadIdentity();
